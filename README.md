...
I worked on it on Ubuntu. The projects builds and runs well on other OS, the only issue is that the interface sometimes looks different and not so beautifull it meant to be:)
